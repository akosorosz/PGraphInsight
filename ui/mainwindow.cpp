...
//			qDebug() << problemData.c_str();
			...
			{
				PnsTools::AlgorithmSSG ssg(pnsProblem);
				ssg.run();
			...
			{
				PnsTools::AlgorithmABB abb(pnsProblem, runParameters.numberOfSolutions, PnsTools::AlgorithmABB::EvaluationType(runParameters.evaluation));
				abb.run();
